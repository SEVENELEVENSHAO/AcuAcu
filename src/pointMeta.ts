...
export const pointMeta: Record<string, PointMeta> = {
  ...
  "LI 18": { code: "LI 18", chineseName: "扶突", actions: ["regulateQi"] },
  "LI 20": { code: "LI 20", chineseName: "迎香", actions: ["release"] },
  "BL 10": { code: "BL 10", chineseName: "天柱", actions: ["release"] },
  ...
  "BL 32": { code: "BL 32", chineseName: "次髎", actions: ["moveBlood", "regulateQi"] },
  "BL 40": { code: "BL 40", chineseName: "委中", actions: ["clearHeat", "moveBlood"] },
  "BL 42": { code: "BL 42", chineseName: "魄户", actions: ["tonifyQi", "stopSweat"] },
  "BL 43": { code: "BL 43", chineseName: "膏肓", actions: ["tonifyQi", "nourishYin"] },
  "CV 3": { code: "CV 3", chineseName: "中极", actions: ["promoteWater", "regulateQi"] },
  ...
  "GV 3": { code: "GV 3", chineseName: "腰阳关", actions: ["warmYang"] },
  "GV 4": { code: "GV 4", chineseName: "命门", actions: ["warmYang"] },
  "GV 9": { code: "GV 9", chineseName: "至阳", actions: ["regulateQi"] },
  ...
  "GV 23": { code: "GV 23", chineseName: "上星", actions: ["release"] },
  ...
  "GB 2": { code: "GB 2", chineseName: "听会", actions: ["clearHeat"] },
  "GB 14": { code: "GB 14", chineseName: "阳白", actions: ["release"] },
  "GB 24": { code: "GB 24", chineseName: "日月", actions: ["regulateQi"] },
  "GB 41": { code: "GB 41", chineseName: "足临泣", actions: ["regulateQi"] },
  "SI 19": { code: "SI 19", chineseName: "听宫", actions: ["clearHeat"] },
  "TE 17": { code: "TE 17", chineseName: "翳风", actions: ["release", "regulateQi"] },
  "ST 6": { code: "ST 6", chineseName: "颊车", actions: ["regulateQi"] },
  "ST 7": { code: "ST 7", chineseName: "下关", actions: ["regulateQi"] },
  "ST 9": { code: "ST 9", chineseName: "人迎", actions: ["regulateQi"] },
  "ST 28": { code: "ST 28", chineseName: "水道", actions: ["promoteWater"] },
  "ST 29": { code: "ST 29", chineseName: "归来", actions: ["warmYang", "moveBlood"] },
  "KI 2": { code: "KI 2", chineseName: "然谷", actions: ["clearHeat", "nourishYin"] },
  "KI 10": { code: "KI 10", chineseName: "阴谷", actions: ["nourishYin"] },
  "KI 14": { code: "KI 14", chineseName: "四满", actions: ["moveBlood"] },
  "LR 8": { code: "LR 8", chineseName: "曲泉", actions: ["nourishYin"] },
